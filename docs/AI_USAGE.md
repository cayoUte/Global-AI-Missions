...
- **Orquestación e integración:** lanzar cada agente con su tarea, pasar el trabajo entre fases, decidir qué entraba y qué se recortaba (la vista de profesor y el replay simulado quedaron fuera), y organizar los commits de las fases 0–2.
